...
function createPopupMercadoLibre(data) {
    ...
    <div class="container">
      <div class="modal">
        <div class="modal-header">
          ...
          <h2 class="option-title">Plan: ${data.name}</h2>        
          <h2>Estas a punto de comprar el acceso a <strong>${data.tokens}</strong> cursos</h2>
          <h6 class="option-price">Precio real: USD ${data.price}</h6>
          <h4 class="option-price">+Impuestos: <br> 
          USD ${data.totalPrice} </h4>
          <br>
        ...
        <div id="mercadopago-button-container" style="width: 100%; height: 50px; margin-top: 20px;">
  ...
  script.dataset.preferenceId = data.preferenceId;
